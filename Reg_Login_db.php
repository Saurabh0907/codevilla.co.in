...
//here
	...
	$id = rand();
		...
		$new = strrev($password1);
		$password1 = hash("sha512", $new); 
		
		$hash1 = md5( rand(1000,2000) );
		$val = 0;
		$query = "insert into user1(name,phone,email,password,identity,hash,active) values('$name','$tel','$email','$password1','$id','$hash1','$val')";
